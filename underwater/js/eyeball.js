  ...
  svgRiskAmount.append("circle")
    ...
    .on("mouseover", function(d) {
        ...
        return tooltipEyeball
          ...
          .text("total lending amount in Boston.");
        })
  ...
  svgRiskAmount.append("circle")
    ...
    .on("mouseover", function(d) {
        ...
        return tooltipEyeball
          ...
          .style("top", (d3.event.pageY-10)+"px")
          .style("left",(d3.event.pageX+10)+"px")
          .text("5.0% | $2,822,483 thousand lent in the 21in 100yr risk scenario.");
        })
    .on("mouseout", function(d) {
  ...
  svgRiskAmount.append("circle")
    ...
    .on("mouseover", function(d) {
        ...
        return tooltipEyeball
          ...
          .style("top", (d3.event.pageY-10)+"px")
          .style("left",(d3.event.pageX+10)+"px")
          .text("3.3% | $1,866,587 thousand lent in the 21in 10yr risk scenario.");
        })
    .on("mouseout", function(d) {
        d3.select(this).classed("hover", false)
        return tooltipEyeball.style("visibility", "hidden");
  ...
  svgRiskAmount.append("circle")
    ...
    .on("mouseover", function(d) {
        ...
        return tooltipEyeball
          ...
          .style("top", (d3.event.pageY-10)+"px")
          .style("left",(d3.event.pageX+10)+"px")
          .text("2.2% | $1,133,188 thousand lent in the 9in 100yr risk scenario.");
        })
    .on("mouseout", function(d) {
        d3.select(this).classed("hover", false)
        return tooltipEyeball.style("visibility", "hidden");
  ...
  svgRiskAmount.append("circle")
    ...
    .on("mouseover", function(d) {
        ...
        return tooltipEyeball
          ...
          .style("top", (d3.event.pageY-10)+"px")
          .style("left",(d3.event.pageX+10)+"px")
          .text("0.2% | $116,769 thousand lent in the 9in 10yr risk scenario.");
        })
    .on("mouseout", function(d) {
        d3.select(this).classed("hover", false)
        return tooltipEyeball.style("visibility", "hidden");
